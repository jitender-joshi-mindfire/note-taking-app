...
| AB-1013 | Frontend — Search UI with highlights | 6.1, 6.2, 6.3 | frontend | PR open (#29) | [#14](https://github.com/jitender-joshi-mindfire/note-taking-app/issues/14) | `ab-1013-search-ui` (archived: `openspec/changes/archive/2026-07-06-ab-1013-search-ui/`) |
