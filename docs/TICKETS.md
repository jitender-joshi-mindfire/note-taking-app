...
| AB-1007 | Search — full-text with highlight + pagination | 6.1, 6.2, 6.3 | backend | In progress | [#8](https://github.com/jitender-joshi-mindfire/note-taking-app/issues/8) | `ab-1007-search` (archived: `openspec/changes/archive/2026-07-05-ab-1007-search/`) |
