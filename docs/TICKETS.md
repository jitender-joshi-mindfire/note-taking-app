...
| AB-1011 | Frontend — Notes list page | 4.2, 4.5, 4.6 | frontend | PR open (#27) | [#12](https://github.com/jitender-joshi-mindfire/note-taking-app/issues/12) | `ab-1011-notes-list` (archived: `openspec/changes/archive/2026-07-06-ab-1011-notes-list/`) |
