...
| AB-1005 | Notes — pagination, sorting, tag filtering | 4.5 (only — 4.6 deferred to AB-1006) | backend | In progress | [#6](https://github.com/jitender-joshi-mindfire/note-taking-app/issues/6) | `ab-1005-notes-pagination-sorting` (archived: `openspec/changes/archive/2026-07-05-ab-1005-notes-pagination-sorting/`) |
