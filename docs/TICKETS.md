...
| AB-1004 | Notes — full CRUD + soft delete | 4.1, 4.2, 4.3, 4.4 (except 4.4.4, deferred to AB-1008) | backend | PR open ([#20](https://github.com/jitender-joshi-mindfire/note-taking-app/pull/20)) | [#5](https://github.com/jitender-joshi-mindfire/note-taking-app/issues/5) | `ab-1004-notes-crud` (archived: `openspec/changes/archive/2026-07-05-ab-1004-notes-crud/`) |
