...
| AB-1015 | Frontend — Version history drawer + restore | 8.1, 8.2, 8.3, 8.4 | frontend | In progress | [#16](https://github.com/jitender-joshi-mindfire/note-taking-app/issues/16) | `ab-1015-version-history-ui` |
