...
| AB-1014 | Frontend — Share modal + active links | 7.1, 7.2, 7.3, 7.4 | frontend | In progress | [#15](https://github.com/jitender-joshi-mindfire/note-taking-app/issues/15) | `ab-1014-share-modal` |
