...
| AB-1010 | Frontend — Auth pages | 3.1, 3.2, 3.3, 3.4 | frontend | In progress | [#11](https://github.com/jitender-joshi-mindfire/note-taking-app/issues/11) | `ab-1010-frontend-auth` (archived: `openspec/changes/archive/2026-07-06-ab-1010-frontend-auth/`) |
