...
| AB-1012 | Frontend — Note editor with TipTap + autosave | 4.1, 4.3 | frontend | In progress | [#13](https://github.com/jitender-joshi-mindfire/note-taking-app/issues/13) | `ab-1012-note-editor` (archived: `openspec/changes/archive/2026-07-06-ab-1012-note-editor/`) |
