...
| AB-1004 | Notes — full CRUD + soft delete | 4.1, 4.2, 4.3, 4.4 (except 4.4.4, deferred to AB-1008) | backend | In progress | [#5](https://github.com/jitender-joshi-mindfire/note-taking-app/issues/5) | `ab-1004-notes-crud` |
