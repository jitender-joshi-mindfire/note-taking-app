...
| AB-1006 | Tags — CRUD + note count per tag | 5.1, 5.2, 4.6 (deferred from AB-1005 — Tag didn't exist yet) | backend | In progress | [#7](https://github.com/jitender-joshi-mindfire/note-taking-app/issues/7) | `ab-1006-tags` (archived: `openspec/changes/archive/2026-07-05-ab-1006-tags/`) |
