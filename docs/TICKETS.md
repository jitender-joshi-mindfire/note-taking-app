...
| AB-1008 | Sharing — generate link, revoke, public access, atomic view count | 7.1, 7.2, 7.3, 7.4, 4.4.4 (deferred from AB-1004 — ShareLink didn't exist yet) | backend | In progress | [#9](https://github.com/jitender-joshi-mindfire/note-taking-app/issues/9) | `ab-1008-sharing` |
