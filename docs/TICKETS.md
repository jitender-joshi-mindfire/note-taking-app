...
| AB-1009 | Version history — snapshot, list, view, restore, auto-purge | 8.1, 8.2, 8.3, 8.4, 8.5 | backend | In progress | [#10](https://github.com/jitender-joshi-mindfire/note-taking-app/issues/10) | `ab-1009-version-history` (archived: `openspec/changes/archive/2026-07-05-ab-1009-version-history/`) |
